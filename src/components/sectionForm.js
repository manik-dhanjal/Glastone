              ...
              <div className="col-sm-10">
                <form className="form form-contact js-ajax-form" action="https://artemsemkin.com/cassio/html/mail.php" method="POST" data-message-success="Thanks for your message! We will reply you as soon as possible." data-message-error="Something went wrong :( Please contact me directly on cassio@example.com">
                  ...
                  <div className="row form__row">
                    <div className="col-lg-6 form__col">
                      <label className="input-float js-input-float">
                        <input className="input-float__input" type="text" name="visitor_name" required="required" data-msg="Please enter your name" /><span className="input-float__label">Your Name</span><span className="form__error" />
                      </label>
                    </div>
                    <div className="col-lg-6 form__col">
                      <label className="input-float js-input-float">
                        <input className="input-float__input" type="email" name="visitor_email" required="required" data-msg="Please enter a correct e-mail" /><span className="input-float__label">Your E-mail</span><span className="form__error" />
                      </label>
                    </div>
                  </div>
                  <div className="row form__row">
                    <div className="col form__col">
                      <label className="input-float js-input-float">
                        <textarea className="input-float__input input-float__input_textarea" name="visitor_msg" defaultValue={""} /><span className="input-float__label">Your Message</span><span className="form__error" />
                      </label>
                    </div>
                  </div>
                  <div className="row form__row">
